...
COMPONENT_LDFLAGS += -L$(BUILD_DIR_BASE)/esp_system -lesp_system -u __ubsan_include -u ld_include_panic_highint_hdl -T $(BUILD_DIR_BASE)/esp_system/ld/memory.ld -T $(BUILD_DIR_BASE)/esp_system/ld/sections.ld 
